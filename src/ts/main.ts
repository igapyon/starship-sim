// @ts-nocheck
        ...
        function isShipFollowModeActive() {
            ...
            if (typeof beaconTeam === 'undefined') return false;
        ...
        function resizeCanvas() {
            ...
            function pickDimension(primary, secondary, tertiary, screenValue) {
                ...
                if (primary <= 0 || suspiciousByScreen || suspiciousBySecondaryLarge || suspiciousByTertiaryLarge) {
                    if (secondary > 0 && !(screenValue > 0 && secondary < screenValue * 0.25)) return secondary;
                    if (tertiary > 0 && !(screenValue > 0 && tertiary < screenValue * 0.25)) return tertiary;
                    if (screenValue > 0) return screenValue;
                    return fallback;
                }
                return primary;
            }
