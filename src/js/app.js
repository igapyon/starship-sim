        ...
        class Starship {
            ...
            // 船体見た目に寄せた当たり判定半径
            getCollisionRadius() {
                if (this.hull.size === 47) return 31;  // Hull5
                if (this.hull.size === 28) return 20;  // LargeHull
